...
The app works completely offline and stores all expense data locally on your device.

## Advertisements
The app may display ads provided by Google AdMob.

AdMob may collect anonymous data such as:
- Device information
- Advertising ID
- App interaction data

This data is used only to show relevant ads and improve ad performance.

## Data Storage
All expense data is stored locally on your device.
We do not upload, share, or sell your data.
